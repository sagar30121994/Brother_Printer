...
class _QlBluetoothPrintPageState extends State<QlBluetoothPrintPage> {
  ...
  void print(BuildContext context) async {
    ...
    // Get a list of printers with my model available in the network.
    List<BluetoothPrinter> printers = await printer.getBluetoothPrinters([Model.QL_820NWB.getName()]);
    ...
    printer.setPrinterInfo(printInfo);
    printer.printImage(await loadImage("asa"));
          ...
          child: Center(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("Order No : 0001", style: Theme.of(context).textTheme.headline6!.copyWith(
                  fontWeight: FontWeight.bold
                ),),
                SizedBox(height: 16,),
                Text("Entity ID : 17261"),

                SizedBox(height: 16,),
                Image(image: AssetImage('assets/qr.png'),height: 150),
                SizedBox(height: 16,),
                Text("Customer Name :",style: Theme.of(context).textTheme.subtitle1!.copyWith(
                    fontWeight: FontWeight.bold
                ),),
                Text("Sagar Thorat"),

                SizedBox(height: 16,),
                Text("Customer Address :",style: Theme.of(context).textTheme.subtitle1!.copyWith(
                    fontWeight: FontWeight.bold
                ),),
                Text("401 Washington Boukeward Apt 3606, Jersey City \n New Jersey, 07310 ",style: Theme.of(context).textTheme.subtitle1!.copyWith(

                ),textAlign: TextAlign.center),

                SizedBox(height: 16,),
                Text("Customer Telephone :",style: Theme.of(context).textTheme.subtitle1!.copyWith(
                    fontWeight: FontWeight.bold
                ),),
                Text("7741919844"),

                SizedBox(height: 16,),
                Text("Delivery Time Slot :",style: Theme.of(context).textTheme.subtitle1!.copyWith(
                    fontWeight: FontWeight.bold
                ),),
                Text("2019-09-07 : 10:00 am - 12:00 pm"),

                SizedBox(height: 16,),
                Text("Store Name :",style: Theme.of(context).textTheme.subtitle1!.copyWith(
                    fontWeight: FontWeight.bold
                ),),
                Text("Apna Bazar Jersey City"),
  ...
  Future<ui.Image> loadImage(String? assetPath) async {
    ...
    final Completer<ui.Image> completer = new Completer();
    ui.decodeImageFromList(_imageFile!, (ui.Image img) {
      return completer.complete(img);
    });
    // final ByteData img = await rootBundle.load(assetPath);
    // final Completer<ui.Image> completer = new Completer();
